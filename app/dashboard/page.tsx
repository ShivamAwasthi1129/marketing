  ...
  const quickActions = [
    {
      ...
      icon: Plus,
      href: "/clients",
      color: "bg-primary text-slate-900 dark:text-white",
    },
    {
      title: "Run SEO Audit",
      ...
      icon: Search,
      href: "/seo-audit",
      color: "bg-secondary text-slate-900 dark:text-white",
    },
    {
      ...
      icon: FileText,
      href: "/reports",
      color: "bg-orange-500 text-slate-900 dark:text-white",
    },
  ]
          ...
          <main className="pt-8 pb-20 px-4">
            <div className="container mx-auto max-w-7xl">
                ...
                {kpiCards.map((kpi, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileHover={{ y: -2 }}
                    >
                      <Card className="border-0 shadow-sm dark:shadow-none hover:shadow-sm dark:shadow-none transition-all duration-300">
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-8">
                ...
                >
                  <Card className="border-0 shadow-sm dark:shadow-none h-full">
                    <CardHeader>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                >
                  <Card className="border-0 shadow-sm dark:shadow-none">
                    <CardHeader>
                      ...
                      {clients.length > 0 ? (
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-muted-foreground mb-4">
                            Add your first client to get started with ONS Media Group.
                          </p>
                          <Link href="/clients">
