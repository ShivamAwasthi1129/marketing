      ...
      <div className="max-w-2xl mx-auto text-center space-y-8">
        <div className="flex justify-center mb-8">
          <div className="flex items-center space-x-3">
            <img src="/mts-logo.png" alt="ONS Media Group Logo" className="w-12 h-12" />
            <div>
              <span className="font-montserrat font-bold text-2xl text-gray-900">ONS Media</span>
              <p className="text-sm text-gray-600">Delhi Digital Marketing Agency</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#0a0a0a]/70 backdrop-blur-sm rounded-2xl p-8 border border-slate-300 dark:border-white/20 shadow-sm dark:shadow-none">
