    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="opacity-100">
          <Card className="border-0 shadow-md dark:shadow-none">
            <CardHeader className="text-center space-y-4">
              <div className="flex justify-center">
                <div className="relative w-16 h-16 p-2 bg-white dark:bg-[#0a0a0a] rounded-2xl shadow-sm dark:shadow-none">
                  <Image src="/mts-logo.png" alt="ONS Media Group Logo" width={48} height={48} className="object-contain" />
                </div>
              </div>
              ...
              <div>
                ...
                <CardDescription className="text-base">
                  {isSignUp
                    ? "Start managing your campaigns with ONS Media Group"
                    : "Sign in to your ONS Media Group account"}
                </CardDescription>
                <p className="text-sm text-muted-foreground mt-1">Delhi Digital Marketing Agency</p>
              </div>
            </CardHeader>
              ...
              {!isSignUp && (
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="text-sm space-y-1">
                    <p>
                      <strong>Email:</strong> demo@onsmedia.in
                    </p>
                    <p>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setFormData({ name: "", email: "demo@onsmedia.in", password: "demo123" })
                    }}
                  >
