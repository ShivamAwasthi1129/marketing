        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-8">
            <div className="hero-badge inline-flex items-center gap-3 rounded-full border border-yellow-500/20 bg-white dark:bg-[#0a0a0a]/70 px-4 py-3 text-sm text-yellow-400 shadow-sm dark:shadow-none shadow-slate-100">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-yellow-500 text-white font-black">CN</span>
              <div>
                <p className="font-semibold text-slate-900 dark:text-white">Clixnova Media</p>
            ...
            <div className="space-y-6">
              ...
              <p className="hero-copy max-w-2xl text-lg leading-8 text-slate-800 dark:text-slate-200 font-medium sm:text-xl">
                At Clixnova Media, we connect brands with high-quality traffic sources to deliver measurable growth, real users, and performance-focused results. From affiliate marketing to media buying and lead generation, we help businesses scale faster with data-driven strategies and global reach.
              </p>
            </div>
          ...
          <div className="hero-image relative overflow-hidden rounded-[2rem] border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]/80 p-4 shadow-md dark:shadow-none shadow-slate-200 sm:p-6">
            <Image
              src="/laptop.jpg"
              alt="Clixnova Media dashboard preview"
              width={900}
              height={560}
