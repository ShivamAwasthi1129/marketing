        ...
        <div className="flex items-center justify-between h-10 text-sm">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2 hover:text-slate-900 dark:text-white/80 transition-colors text-slate-900 dark:text-white">
              ...
              <span className="text-slate-900 dark:text-white">info@onsmediagroup.com</span>
            </div>
            <div className="flex items-center space-x-2 hover:text-slate-900 dark:text-white/80 transition-colors text-slate-900 dark:text-white">
              <MapPin className="w-3 h-3 text-slate-900 dark:text-white" />
              <span className="text-slate-900 dark:text-white">Delhi, India</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="animate-pulse">
              <span className="text-xs font-medium text-slate-900 dark:text-white">🎉 New: AI-Powered Analytics Dashboard - Try Free!</span>
            </div>
          </div>
        </div>
      </div>
