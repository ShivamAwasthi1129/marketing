...
export function DashboardSidebar({ isCollapsed = false, onToggle }: DashboardSidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className={`fixed left-0 top-0 h-full bg-sidebar border-r border-sidebar-border shadow-sm dark:shadow-none z-40 overflow-y-auto ${
      ...
      <div className="flex flex-col h-full">
        ...
        {!isCollapsed && (
          <div className="p-4 border-t border-sidebar-border">
            <div className="p-3 rounded-lg bg-gradient-primary-secondary text-slate-900 dark:text-white">
