...
export function SEOAuditCard({ audit, onView, onDelete, onExport }: SEOAuditCardProps) {
  ...
  return (
    <Card className="hover:shadow-sm dark:shadow-none transition-shadow">
      ...
      <CardContent>
        ...
        <div className="flex justify-between mb-4">
          <div className="text-center">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-slate-900 dark:text-white text-xs font-bold ${getScoreBgColor(audit.metrics.performance)}`}
            >
          ...
          <div className="text-center">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-slate-900 dark:text-white text-xs font-bold ${getScoreBgColor(audit.metrics.accessibility)}`}
            >
          ...
          <div className="text-center">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-slate-900 dark:text-white text-xs font-bold ${getScoreBgColor(audit.metrics.bestPractices)}`}
            >
          ...
          <div className="text-center">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-slate-900 dark:text-white text-xs font-bold ${getScoreBgColor(audit.metrics.seo)}`}
            >
              {audit.metrics.seo}
            </div>
