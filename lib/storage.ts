...
const STORAGE_KEYS = {
  ...
  SESSION: "ons_session",
  CLIENTS: "ons_clients",
  SEO_AUDITS: "ons_seo_audits",
  REPORTS: "ons_reports",
  MESSAGES: "ons_messages",
} as const
...
export const storage = {
  ...
  setSession: (session: Session | null) => {
    ...
    if (session) {
      ...
      document.cookie = "ons_session=true; path=/; max-age=86400"
    } else {
      localStorage.removeItem(STORAGE_KEYS.SESSION)
      document.cookie = "ons_session=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT"
    }
  },
...
export const initializeDemoData = () => {
  ...
  const demoClients: Client[] = [
    ...
    },
    {
      ...
      domain: "techstart.io",
      email: "Sagar digital Marketingtechstart.io",
      phone: "+880181234567",
...
export const initializeDemoUser = () => {
  ...
  if (users.find((u) => u.email === "demo@onsmedia.in")) {
    return
  }
